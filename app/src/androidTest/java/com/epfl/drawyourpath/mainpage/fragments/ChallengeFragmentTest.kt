...
class ChallengeFragmentTest {
    ...
    fun displayNewDistanceGoalWhenNoTodayDailyGoal() {
        ...
        onView(withId(R.id.goals_view)).perform(scrollToPosition<RecyclerView.ViewHolder>(0))
    ...
    fun displayNewTimeGoalWhenNoTodayDailyGoal() {
        ...
        onView(withId(R.id.goals_view)).perform(scrollToPosition<RecyclerView.ViewHolder>(1))
    ...
    fun displayNewNbPathsGoalWhenNoTodayDailyGoal() {
        ...
        onView(withId(R.id.goals_view)).perform(scrollToPosition<RecyclerView.ViewHolder>(2))
            .check(matches(hasDescendant(withText(pathProgressGoal)))).check(matches(hasDescendant(withText(mockUser.goals!!.paths!!.toString()))))
